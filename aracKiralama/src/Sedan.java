public class Sedan implements Arac {
    ...
    public Sedan(String marka, String model, String segment, String vitesTipi,
    ...
    public double aylikKiralamaBedeliHesapla(int sure) {
        ...
        double aylikBedel = gunlukBedel * 30;
        aylikBedel -= aylikBedel * 0.07; // %7 indirim
